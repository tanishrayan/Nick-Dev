...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants().mass(11.56661).headingPIDFCoefficients(new PIDFCoefficients(-0.8, 0.005, 0.02,0.001));
